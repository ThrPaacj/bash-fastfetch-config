...
static const char *const autostart[] = {
  ...
  "sh", "-c", "feh --randomize --bg-fill /home/thrp/Pictures/backgrounds/*", NULL,
  "xautolock", "-time", "5", "-locker", "~/dwm/slock/scripts/pause-on-lock.sh", NULL,
  "slstatus", NULL,
  "caffeine", NULL,
  "redshift-gtk", NULL,
  NULL /* terminate */
...
static Key keys[] = {
	...
	{ 0,                            XF86XK_MonBrightnessUp,    spawn,                  SHCMD ("brightnessctl set +10")}, // increase backlight brightness
	{ 0,                            XF86XK_MonBrightnessDown,  spawn,                  SHCMD ("brightnessctl set 10-")}, // decrease backlight brightness
	{ 0,                            XF86XK_AudioLowerVolume,   spawn,                  SHCMD ("pactl set-sink-volume @DEFAULT_SINK@ -5%")}, // decrease volume and unmute
	{ 0,                            XF86XK_AudioMute,          spawn,                  SHCMD ("pactl set-sink-mute @DEFAULT_SINK@ toggle")}, // toggle mute/unmute
	{ 0,                            XF86XK_AudioRaiseVolume,   spawn,                  SHCMD ("pactl set-sink-volume @DEFAULT_SINK@ +5%")}, // increase volume and unmute
